...
sed -i 's|git clone https://github.com/tmh190788/cyberpanel|echo downloaded|g' install.py
...
#line1="$(grep -n "github.com/tmh190788/cyberpanel" install.py | head -n 1 | cut -d: -f1)"
#line2=$((line1 - 1))
...
sed -i 's|git clone https://github.com/tmh190788/cyberpanel|wget https://cyberpanel.sh/cyberpanel-git.tar.gz \&\& tar xzvf cyberpanel-git.tar.gz|g' install.py
...
wget -O requirements.txt https://raw.githubusercontent.com/tmh190788/cyberpanel/1.8.0/requirments.txt
...
if [[ $DEV == "ON" ]] ; then
	#install dev branch 
	#wget https://raw.githubusercontent.com/tmh190788/cyberpanel/$BRANCH_NAME/requirments.txt
	cd /usr/local/
	python3.6 -m venv CyberPanel
	source /usr/local/CyberPanel/bin/activate
	wget -O requirements.txt https://raw.githubusercontent.com/tmh190788/cyberpanel/$BRANCH_NAME/requirments.txt
...
if [[ $SERVER_COUNTRY == "CN" ]] ; then
	...
	if [[ $DEV == "ON" ]] ; then
	git clone https://github.com/tmh190788/cyberpanel
	cd cyberpanel
