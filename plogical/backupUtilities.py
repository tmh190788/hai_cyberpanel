...
class backupUtilities:
    ...
    def prepareBackupMeta(backupDomain, backupName, tempStoragePath, backupPath, FromInner=1):
        try:
            ...
            ### try to take care of - https://github.com/tmh190788/cyberpanel/issues/1196
    ...
    def startBackup(tempStoragePath, backupName, backupPath, metaPath=None):
        try:
            ...
            ### doing backup of whole dir and keeping it in public_html folder will restore from here - ref https://github.com/tmh190788/cyberpanel/issues/1196
