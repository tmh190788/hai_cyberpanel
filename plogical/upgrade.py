...
class Upgrade:
    ...
    def download_install_phpmyadmin():
        try:
            ...
            command = 'wget -O /usr/local/CyberCP/public/phpmyadmin.zip https://github.com/tmh190788/cyberpanel/raw/stable/phpmyadmin.zip'
            Upgrade.executioner(command, 0)
    ...
    'rootdb': {
        ...
        'PORT': '%s',
            ...
            if currentBranch.find('On branch %s' % (branch)) > -1 and currentBranch.find(
                ...
                command = 'git clone https://github.com/tmh190788/cyberpanel'
                if not Upgrade.executioner(command, command, 1):
                    return 0, 'Failed to execute %s' % (command)
...
"""
    ...
    def runSomeImportantBash():
        ...
        # Remove invalid crons from /etc/crontab Reference: https://github.com/tmh190788/cyberpanel/issues/216
...
'''
    ...
    def upgrade(branch):
        ...
        if not os.path.exists('/usr/local/lsws/bin/openlitespeed'):
            ...
            command = 'wget https://raw.githubusercontent.com/tmh190788/cyberpanel/stable/install/litespeed/httpd_config.xml'
            Upgrade.executioner(command, command, 0)
